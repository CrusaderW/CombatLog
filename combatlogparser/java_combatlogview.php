...
?>
<script src="<?=$us_url_root?>combatlogparser/functions.js"></script>
<?php
                    ...
                    switch ($view){
                                            ...
                                            foreach ($maps as $m) {
                                                ...
                                                foreach($pois as $p){
                                                    if ($p['map_name']==$m AND $p['campaign_name']==$c){
                                                        echo "<font size='2'><a href='java_combatlogview.php?view=day&day=$d&poi=".$p['poi_id']."'>".$p['poi_name'].'</a>; </font>';
                                                    }
                                                }
                                            }
                                            echo'<hr>';
                        ...
                        case ('day'):
                            ...
                            <form enctype="multipart/form-data" name='deleteFight' action='<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>' method='post'>
                                ...
                                ?>
                                <p id='pShow' name='pShow'>Loading...</p>
...
<script type="text/javascript">
    ...
    switch(view){
        case 'day':
            multiSort(dayData,{date_time: 'asc' });
            var fpHTML;
            var fightsAndPlayers=jsGetFightsAndPlayers(dayData);
            //alert (fightsAndPlayers['players'][0]);
            var p=1;
            //for (var i=0, n=fights.length; i < n; ++i ) {
                
            //}
            
            
            fpHTML= JSON.stringify(fightsAndPlayers);
            document.getElementById("pShow").innerHTML=fpHTML;
